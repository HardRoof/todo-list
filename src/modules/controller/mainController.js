class Controller {
  ...
  toDoFormAction(e) {
    e.preventDefault();
    this.createDisplayTodoItem(
      this.model.getFormElements().title.value,
      this.model.getFormElements().description.value,
      this.model.getFormElements().dueDate.value,
      this.model.getFormElements().project.value,
      this.model.getFormElements().priority.value,
      this.model.getFormElements().completed
    );
    this.model.clearForm();
  }

  createDisplayTodoItem(title, description, dueDate, project, priority, completed) {
    this.view.showContent();
    let increment = this.model.counter();
    let toDoItem = this.model.generatesToDoItem(increment, title, description, dueDate, project, priority, completed);
  ...
  noteFormAction(e) {
    e.preventDefault();
    this.createDisplayNote(
      this.model.getFormElements().noteTitle.value,
      this.model.getFormElements().noteDescription.value
    );
