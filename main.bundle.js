...
// ************************************************** //
  ...
  loadNotes() {
    this.model.notes.forEach((note) => {
      this.createDisplayNote(note.noteTitle, note.description);
    });
  };
...
class Model {
  constructor() {
    ...
    this.projects = JSON.parse(localStorage.getItem('projects')) || {Inbox: []};
  };
  ...
  formatDate(dueDate) {
    if (dueDate.length > 8) {
    const formattedData = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(dueDate), 'MMM do');  // parse ISO string before formatting it
    return formattedData
    } else return dueDate
  };

  generatesToDoItem(increment, title, description, dueDate, project, priority, completed) {
    let toDoItem = new _toDoList_js__WEBPACK_IMPORTED_MODULE_0__.ToDoList(title, description, this.formatDate(dueDate), project, priority, completed);
  ...
  generatesNote(increment, noteTitle, noteDescription) {
    let noteItem = new _noteList_js__WEBPACK_IMPORTED_MODULE_1__.noteList(noteTitle, noteDescription);
